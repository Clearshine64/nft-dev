    ...
    <div id="member-ship">
      <div className="container">
        <div className="row logo-title">
          <div className="col-xs-12 col-md-7 logo-detail">
            <h3> Say Marhaba to the Camels </h3>
          ...
          <div className="col-xs-12 col-md-5" style={{textAlign:'center'}}>
            <img src="img/Crypto-Camels_v1.png" className="membership-logo" alt="" />
            <p style={{height: '60px'}}></p>
            <img src="img/Crypto-Camels_v2.png" className="membership-logo" alt="" />
          </div>
        </div>
        {/* <div className="row">
